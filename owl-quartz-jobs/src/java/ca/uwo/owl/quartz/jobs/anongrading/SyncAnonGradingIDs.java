...
public class SyncAnonGradingIDs implements Job 
{
	...
	public void execute( JobExecutionContext jobExecutionContext ) throws JobExecutionException
	{
		...
		try
		{
			...
			*/
			...
			List<AnonGradingCSVRow> newRows = new ArrayList<AnonGradingCSVRow>();
	...
	private List<AnonGradingCSVRow> detectDuplicates(List<AnonGradingCSVRow> csvRows)
	{
		...
		//our return value
		final List<AnonGradingCSVRow> duplicates = new ArrayList<AnonGradingCSVRow>();
		...
		*/
		...
		Set<Integer> skippableIndices = new HashSet<Integer>();
